...
public class EmployeeTest {
	...
	// 13,16,18,19line 주석을 풀고 20,21을 주석한 후 실행해보면 두 인스턴스 다 ++가 되어있다. 
...
//		System.out.println(employeeLee.serialNum); // 노란색 줄 : 얘는 static변수로 참조되어있으니, 클래스로 사용해라.
		...
		System.out.println(Employee.getSerialNum()); // Employee라는 클래스는 private로 선언되어있어 외부참조가 불가능하지만, get메서드를 사용하면 가능하다.
